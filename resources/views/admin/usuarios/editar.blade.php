...
<div class="container" id="formularioAgregar">
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <div class="card">
                <div class="card-header">Edite los campos que desee</div>
<br>
                <div class="card-body">

                    <form class="row g-4" action="{{ route('usuarios.update', $usuario->id) }}" method="POST">
                        {{-- Token de seguridad --}}
                        @method('PUT')
                        @csrf
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="correo" type="email" class="form-control @error('correo') is-invalid @enderror" name="correo" value="{{ $usuario->correo }}" required autocomplete="email">
