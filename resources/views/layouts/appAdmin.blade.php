        ...
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/admin') }}">
                    {{ config('app.name', 'Laravel') }} - Administrador
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        @if (Session::has('LoggedAdmin'))
                            <li class="nav-item">
                                <a class="nav-link text-center @if(Route::currentRouteName() == 'admin.panelPrincipal') border border-secondary rounded-pill @endif" href="{{ route('admin.panelPrincipal') }}">CRUD de Dispositivos</a>
                            </li>
                            <li class="nav-item">
